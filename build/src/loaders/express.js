...
var TicTacToe1 = /** @class */ (function () {
    ...
    TicTacToe1.prototype.tic = function () {
    ...
    ], TicTacToe1.prototype, "tic", null);
    TicTacToe1 = __decorate([
        (0, type_graphql_1.Resolver)()
    ], TicTacToe1);
    return TicTacToe1;
}());
exports.TicTacToe1 = TicTacToe1;
exports.default = (function (_a) {
    ...
    app.get("/vieja", function (req, res) { res.send("ssss"); });
    app.use("/joder", function () { return __awaiter(void 0, void 0, void 0, function () {
        var schema, server;
        return __generator(this, function (_a) {
            switch (_a.label) {
