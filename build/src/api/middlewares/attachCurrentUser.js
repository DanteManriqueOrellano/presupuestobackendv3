...
var userRepository = (0, fireorm_1.getRepository)(user);
var attachCurrentUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userRecord, currentUser, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userRepository.findById(req.token._id)];
            case 1:
                userRecord = _a.sent();
            ...
            case 2:
                e_1 = _a.sent();
                console.error('🔥 Error attaching user to req: %o', e_1);
